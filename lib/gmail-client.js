...
class GmailService {
  ...
  async sendEmail({ to, subject, html, text, cc = null, attachments = [] }) {
    try {
      ...
      const mailOptions = {
        from: {
          name: 'EkoSolarPros',
          address: process.env.GMAIL_USER || 'ekosolarize@gmail.com'
        },
        to,
        subject,
        html,
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="actions">
              <h3>Quick Actions:</h3>
              <a href="mailto:${formData.email}?subject=Re: Your Solar Consultation Request&body=Hi ${formData.name},%0D%0A%0D%0AThank you for your interest in solar energy!" class="button">Reply to Customer</a>
